...
<?php $__env->startSection('pageCss'); ?>
    <link href="<?php echo e(asset(_HOME_ . '/css/detail.css')); ?>" rel="stylesheet"/>
    <link rel="stylesheet" href="<?php echo e(asset(_ADMIN_ . '/static/editor/css/editormd.preview.css')); ?>"/>
    <style>
                ...
                <div class="blog-main-left">
                    ...
                    <div class="article-detail shadow">
                        ...
                        <div class="article-detail-info">
                            <span>创建时间：<?php echo e($article['created_at']); ?></span>
                            <span>上次编辑：<?php echo e($article['updated_at']); ?></span>
                            <span>浏览量：<?php echo e($article['read_times']); ?></span>
                        </div>
                        <div class="article-detail-content">
                            <p style="text-align:center;">
                                <span style="font-size:18px;">文章分类：<?php echo e($article['category']['cate_title']); ?></span>
                            </p>


                            <div style="text-align:center;">
                                &nbsp; &nbsp; <span
                                        style="color:#EE33EE;">前言</span>：<?php echo e(isset($article['note']) ? $article['note'] : '暂无'); ?>
                            ...
                            <div id="test-editormd-view">
                                <textarea id="append-test" style="display:none;"><?php echo e($article['content']); ?></textarea>
                            </div>
                            ...
                            <p>
                                ...
                                <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    &nbsp; &nbsp; <a href="/article?tag=<?php echo e($tag['id']); ?>" target="_blank"><span
                                                style="color:#337FE5;"><?php echo e($tag['name']); ?></span></a>
                            ...
                            <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <div class="comment-parent">
                                        <img src="<?php echo e(asset(_HOME_ . '/images/Absolutely.jpg')); ?>" alt="洛克哈特"/>
                                        <div class="info">
                                            <span class="username"><?php echo e($comment['userName']); ?></span>
                                            <span class="time"><?php echo e($comment['created_at']); ?></span>
                                        </div>
                                        <div class="content">
                ...
                <div class="blog-main-right">
                    ...
                    <div class="blog-module shadow">
                        ...
                        <ul class="fa-ul blog-module-ul">
                            ...
                            <li><i class="fa-li fa fa-hand-o-right"></i><a href="/detail/<?php echo e($like['id']); ?>"><?php echo e($like['title']); ?></a>
                            </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
                    <div class="blog-module shadow">
                        ...
                        <ul class="fa-ul blog-module-ul">
                            <?php $__currentLoopData = $rands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><i class="fa-li fa fa-hand-o-right"></i><a href="/detail/<?php echo e($rand['id']); ?>"><?php echo e($rand['title']); ?></a></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
                </div>
...
<?php $__env->startSection('pageJs'); ?>
    <!-- 比较好用的代码着色插件 -->
    <script src="<?php echo e(asset(_HOME_ . '/js/prettify.js')); ?>"></script>
    <!-- 本页脚本 -->
    <script src="<?php echo e(asset(_ADMIN_ . '/static/editor/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset(_ADMIN_ . '/static/editor/lib/marked.min.js')); ?>"></script>
    <script src="<?php echo e(asset(_ADMIN_ . '/static/editor/lib/prettify.min.js')); ?>"></script>
    <script src="<?php echo e(asset(_ADMIN_ . '/static/editor/lib/raphael.min.js')); ?>"></script>
    <script src="<?php echo e(asset(_ADMIN_ . '/static/editor/lib/underscore.min.js')); ?>"></script>
    <script src="<?php echo e(asset(_ADMIN_ . '/static/editor/lib/sequence-diagram.min.js')); ?>"></script>
    <script src="<?php echo e(asset(_ADMIN_ . '/static/editor/lib/flowchart.min.js')); ?>"></script>
    <script src="<?php echo e(asset(_ADMIN_ . '/static/editor/lib/jquery.flowchart.min.js')); ?>"></script>
    <script src="<?php echo e(asset(_ADMIN_ . '/static/editor/editormd.min.js')); ?>"></script>
    ...
    <script type="text/javascript">
        ...
        layui.use(['form', 'layedit', 'tree'], function () {
            ...
            $(function(){
                $('img').click(function(){
                    $(this).attr('src','<?php echo e(captcha_src('mini')); ?>' + '&_=' + Math.random());
                })
            })

            // 显示评论
            var id = <?php echo e($article['id']); ?>;
            var imgSrc = "<?php echo e(asset(_HOME_ . '/images/Absolutely.jpg')); ?>";
            $.ajax({
                headers: {
            ...
            tree({
                elem: "#cateTree"
                ,
                nodes: <?php echo json_encode($categories, 15, 512) ?>
                ,
                click: function (node) {
