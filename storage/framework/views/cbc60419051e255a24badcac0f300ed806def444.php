...
<?php $__env->startSection('pageCss'); ?>
    <link href="<?php echo e(asset(_HOME_ . '/css/about.css')); ?>" rel="stylesheet"/>
                ...
                <div class="layui-tab layui-tab-brief shadow" lay-filter="tabAbout">
                    ...
                    <div class="layui-tab-content">
                        ...
                        <div class="layui-tab-item">
                            <div class="aboutinfo">
                                <div class="aboutinfo-figure">
                                    <img src="<?php echo e(asset(_HOME_ . '/images/handshake.png')); ?>" alt="友情链接"/>
                                </div>
                        ...
                        <div class="layui-tab-item">
                            <div class="aboutinfo">
                                <div class="aboutinfo-figure">
                                    <img src="<?php echo e(asset(_HOME_ . '/images/messagewall.png')); ?>" alt="留言墙"/>
                                </div>
...
<?php $__env->startSection('pageJs'); ?>
    ...
    <script src="<?php echo e(asset(_HOME_ . '/js/about.js')); ?>"></script>
    <script>
