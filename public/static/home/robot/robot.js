(function(win, options, undefined){
	...
	var hideKefu = false										//是否隐藏人工客服
		...
		, cssUrl = '/static/home/robot/css/robot.css'						//远程要加载的css文件地址
		, kfJsUrl = '/static/home/robot/ddp-client.js'						//人工客服库文件
	...
	var _generateHtml = function(source){
		...
		html.push('<div class="'+ cssfix +'content">');
			...
			html.push('<li class="'+ cssfix +'slide-btn" style="background-color:'+_colors.border+';"><a href="javascript:void(0);"><span class="'+ cssfix +'icon"></span>'+ (!_con.kefuOnly ? '聊天' : '在线客服') +'</a></li>');
			// if(!!_con.feedBtn.url){
	...
	Robot.prototype = {
		...
		, 'send': function(text){
			...
			// var _this = this;
			// var $answer = _this.cReplyEle({'text': '<img src="http://img.alicdn.com/imgextra/i3/TB1tAEJJpXXXXXraXXXtKXbFXXX.gif"/>'});
			// _this.chat.append($answer);
			// _this.scroll();
			// $('.'+ cssfix +'msg', $answer).css('min-width', '75%');
			// $('.'+ cssfix +'msg-mm .'+ cssfix +'htmcont', $answer).html('会话丢失123');
			// return false;
			...
			ws.onmessage = function(data) {
				...
				var $answer = _this.cReplyEle({'text': $answer});


				_this.chat.append($answer);
				_this.scroll();

				$('.'+ cssfix +'msg-mm .'+ cssfix +'htmcont', $answer).html(response);
	...
	//新窗口打开新页面的URL,手机版有效
	, 'newurl': '?mobile'
	// , 'logo': 'https://cloud.smartnlp.cn/cloud/res/win-logo/55d28d61d3a93df500131c24.png'
	, 'logo': "/static/home/images/Absolutely.jpg"
