                    ...
                    <div class="layui-tab-item layui-show">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="title" lay-verify="required" jq-error="请输入文章标题"
                                       placeholder="请输入文章标题" autocomplete="off" class="layui-input">
                                <input type="hidden" class="pid" value="0" name="cate_id">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            @foreach ($tags as $tag)
                                <div class="layui-input-inline" id="insertInput11">
                                    <input readonly type="text" value="{{ $tag['name'] }}" autocomplete="off"
                                           placeholder="请输入" lay-verify="required" class="layui-input tag">
                                </div>
                            @endforeach
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" value="" name="tags" autocomplete="off"
                                       placeholder="请选择上方标签，如要添加新标签，以英文逗号间隔输入，如‘标签1,标签2’" lay-verify="required"
                                       class="layui-input choosed-tags">
