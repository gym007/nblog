...
<link rel="stylesheet" href="{{asset(_ADMIN_ . '/static/editor/css/editormd.css')}}">
@section('content')
                ...
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="title" lay-verify="required" jq-error="请输入文章标题" placeholder="请输入文章标题" autocomplete="off" class="layui-input" value="{{$article['title']}}">
                            <input type="hidden" class="pid" value="{{$article['cate_id']}}" name="cate_id">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        @foreach ($tags as $tag)
                            <div class="layui-input-inline" id="insertInput11">
                                <input readonly type="text" value="{{ $tag['name'] }}" autocomplete="off" placeholder="请输入" lay-verify="required" class="layui-input tag">
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" value="{{ $tagStr }}" name="tags" autocomplete="off" placeholder="请选择上方标签，如要添加新标签，以英文逗号间隔输入，如‘标签1,标签2’" lay-verify="required" class="layui-input choosed-tags">
...
<script type="text/javascript" src="{{asset(_ADMIN_ . '/static/editor/editormd.min.js')}}"></script>
@endsection
@section('js')
<script>
    layui.extend({
...
// 						treeSelect.checkNode('tree', catId);
                treeSelect.checkNode('tree', {{$article['cate_id']}});
...
//                刷新树结构
    ...
    $(function () {
        ...
        testEditor = editormd("test-editormd", {
            ...
            path: "{{_ADMIN_ . '/static/editor/lib/'}}",   //你的path路径（原资源文件中lib包在我们项目中所放的位置）
